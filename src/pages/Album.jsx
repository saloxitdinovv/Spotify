...
//                             <img className="max-w-[290px] max-h-[290px] w-[250px] h-[250px] rounded object-cover shadow-[0px_0px_65px_4px_rgba(0,0,0,0.54)]" src={album?.images[0]?.url} alt="playlist-card" />
//                         </div>
//                         <div className="playlist_info flex flex-col justify-end gap-3">
//                             <h3 className="text-xl uppercase font-bold text-white">{album.type}</h3>
//                             <h1 className="text-7xl font-bold w-[80%] text-5xl text-white capitalize    ">{album.name}</h1>
//                             <p className="text-[#cbc8c4]">Popularity: {album.popularity}%</p>
//                             <div className="flex  text-[#cbc8c4]">
//                                 <span className="text-white cursor-pointer hover:underline">{album.label}</span>
//                                 <h5>, {album.tracks.items.length} треков</h5>
//                             </div>
//                         </div>
//                     </section>
//                 ) : (
...
export default function PLaylist_page() {
    ...
    return (
        <>
            ...
            {
                playlist?.tracks ? (
                    <div className="backdrop backdrop-blur-[70px] absolute top-0 left-0 right-0 h-[70%] w-full z-[-5] bg-no-repeat bg-cover pb-10 bg-bottom" style={{ backgroundImage: `url(${playlist.images[0].url})` }}></div>
                ) : (
                    <div className="backdrop backdrop-blur-[70px] absolute top-0 left-0 right-0 h-[70%] w-full z-[-1] bg-gradient-to-b from-[#1fdf6570] to-[#161616] pb-10"></div>
                )
            }
